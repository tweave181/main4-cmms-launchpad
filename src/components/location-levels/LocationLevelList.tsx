        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="bg-muted/50">Usage</TableHead>
              <TableHead className="bg-muted/50">Created</TableHead>
            ...
            {locationLevels.length === 0 ? (
              ...
              locationLevels.map((level) => (
                ...
                >
                  ...
                  <TableCell>
                    {level.usage_count !== undefined && level.usage_count > 0 ? (
                      <Badge 
                        variant="outline" 
                        className="cursor-pointer hover:bg-accent"
                        onClick={(e) => handleUsageClick(e, level)}
                      >
                        {level.usage_count}
                      </Badge>
                    ) : (
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              ...
                              size="icon"
                              className="h-8 w-8"
                              disabled={level.usage_count !== undefined && level.usage_count > 0}
                          ...
                          <TooltipContent>
                            <p>
                              {level.usage_count !== undefined && level.usage_count > 0 
                                ? `In use by ${level.usage_count} locations. Deactivate instead.`
                                : 'Delete level'
                              }
                            </p>
                          </TooltipContent>
