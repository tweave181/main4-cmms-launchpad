...
export const UpcomingContractRenewals: React.FC = () => {
  ...
  const { renewals, isLoading, error } = useUpcomingContractRenewals();
        ...
        {renewals.length === 0 ? (
          ...
          <div className="space-y-4">
            {renewals.map((contract) => (
              <div
                key={contract.id}
                className={`p-4 rounded-lg border ${getExpiryColorClass(contract.end_date)}`}
              >
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center text-sm">
                      ...
                      {contract.asset_count !== undefined && contract.asset_count > 0 && (
