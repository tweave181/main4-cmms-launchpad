  ...
  return <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {isAdmin && onDelete && <Button variant="destructive" size="sm" onClick={onDelete} className="flex items-center space-x-2">
                  <Trash2 className="h-4 w-4" />
                  <span>Delete</span>
                </Button>}
              {!canEdit && isCompleted && <Badge variant="secondary" className="text-xs">
                  Read Only
                </Badge>}
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          {workOrder.description && <Card className="rounded-2xl">
              <CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="rounded-2xl">
              ...
              <CardContent className="space-y-3">
                {workOrder.estimated_hours && <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                ...
                {workOrder.estimated_cost && <div className="flex items-center justify-between">
                    <span className="text-sm font-medium">Estimated Cost</span>
                    <span className="text-sm text-gray-600">{formatCurrency(workOrder.estimated_cost)}</span>
                  </div>}
                {workOrder.actual_hours && <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <Clock className="h-4 w-4 text-gray-400" />
                ...
                {workOrder.actual_cost && <div className="flex items-center justify-between">
