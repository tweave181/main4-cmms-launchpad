...
import { User, Mail, Phone, Building2, Briefcase, MapPin, UserCheck, AlertCircle, Pencil } from 'lucide-react';
            ...
            <Alert variant="destructive" className="py-2">
              ...
              <AlertDescription className="text-xs">
                ...
                {editable ? (
                  ...
                  ' Please contact your administrator to update your details.'
                )}
              </AlertDescription>
            </Alert>
          )}
